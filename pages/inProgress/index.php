                            ...
                            <div class="card-default-conteudo group/card">
                                <div class="layer-titulo-default-card ">
                                    ...
                                    <div class="flex space-x-2 items-center">
                                        <button
                                            type="button"
                                            class="cursor-pointer opacity-0 group-hover/card:opacity-100 transition-all text-blue-600 hover:text-blue-800 btn-edit-client"
                                        ...
                                        <form action="../../src/backend/functions/deleteServices.php" method="POST">
                                            ...
                                            <button type="submit" class="cursor-pointer opacity-0 group-hover/card:opacity-100 transition-all text-red-600 hover:text-red-800" onclick="return confirm('Tem certeza que deseja deletar este Serviço?');">
